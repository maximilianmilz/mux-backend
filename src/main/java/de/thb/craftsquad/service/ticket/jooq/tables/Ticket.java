...
public class Ticket extends TableImpl<TicketRecord> {
     ...
     */
    public final TableField<TicketRecord, Status> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(de.thb.craftsquad.service.ticket.jooq.enums.Status.class), this, "");
